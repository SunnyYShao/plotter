...
finalise_plot(plot_name = test_plot,
              source_name = "test",width_pixels = 1400, height_pixels = 800,
              logo_image_path = "~/Dropbox/Shared/AAPIData HQ/Projects/opinion database/aapidata-apia-logo-v2.png",save_filepath = "dta/test.png")
